            ...
            <div class="dashboard">
                ...
                <div class="form-content" style="width: 80%;height: auto; margin-left: 10%; padding-top: 0;padding-bottom: 0;">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" name="txtPassword" id="exampleFormControlInput1">
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="exampleFormControlInput1" name="txtPhone" placeholder="name@example.com">
                    </div>
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="exampleFormControlInput1" name="txtImg" placeholder="name@example.com">
                    </div>
